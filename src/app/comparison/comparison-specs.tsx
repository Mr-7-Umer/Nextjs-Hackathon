  ...
  const specifications = {
    general: {
      ...
      specs: [
        ...
        {
          label: "Model Number",
          product1: "TFCBKBSBS0016",
          product2: "DTGB/DRBS/BS",
        },
        {
    ...
    product: {
      ...
      specs: [
        {
          label: "Brand",
          product1: "Trevi Furniture",
          product2: "XYZ Interiors",
        },
    ...
    warranty: {
      ...
      specs: [
        ...
        },
        {
          ...
          product1:
            "For Warranty Claims or Any Product Related Issues Please Email at operations.com",
          product2:
