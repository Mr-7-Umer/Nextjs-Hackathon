...
const galleryImages = [
  {
    ...
    height: 500,
    className:
      "lg:block hidden col-span-1 lg:col-start-1 lg:col-end-3 lg:row-start-1 lg:row-end-3",
  },
  {
    id: "2",
    ...
    height: 300,
    className:
      "col-span-1 lg:col-start-3 lg:col-end-6 lg:row-start-1 lg:row-end-2",
  },
  {
    id: "3",
    ...
    height: 400,
    className:
      "col-span-1 lg:col-start-3 lg:col-end-5 lg:row-start-2 lg:row-end-3",
  },
  {
    id: "4",
    ...
    height: 280,
    className:
      "col-span-1 lg:col-start-5 lg:col-end-6 lg:row-start-2 lg:row-end-3",
  },
  {
    id: "5",
    ...
    height: 600,
    className:
      "col-span-1 lg:col-start-6 lg:col-end-9 lg:row-start-1 lg:row-end-4",
  },
  {
    id: "6",
    src: "/images/bed.png",
    ...
    height: 350,
    className:
      "col-span-1 lg:col-start-9 lg:col-end-12 lg:row-start-1 lg:row-end-2",
  },
  {
    id: "7",
    ...
    height: 280,
    className:
      "col-span-1 lg:col-start-12 lg:col-end-14 lg:row-start-1 lg:row-end-2",
  },
  {
    id: "8",
    ...
    height: 280,
    className:
      "col-span-1 lg:col-start-9 lg:col-end-11 lg:row-start-2 lg:row-end-3",
  },
  {
    id: "9",
    ...
    height: 280,
    className:
      "col-span-1 lg:col-start-12 lg:col-end-14 lg:row-start-2 lg:row-end-3",
  },
];
